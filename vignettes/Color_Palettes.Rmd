...
```{r include=FALSE}
p1 <- FeaturePlot(object = experiment.aggregate, features = "Mecp2", order = T)
p2 <- FeaturePlot_scCustom(seurat_object = experiment.aggregate, features = "Mecp2", order = T)
p3 <- FeaturePlot_scCustom(seurat_object = experiment.aggregate, colors_use = viridis_magma_dark_high, features = "Mecp2", order = T)
p4 <- FeaturePlot_scCustom(seurat_object = experiment.aggregate, colors_use = viridis_light_high, features = "Mecp2", order = T)
```
...
DimPlot(object = experiment.aggregate, cols = DiscretePalette_scCustomize(num_colors = 26, palette = "polychrome"))
```
